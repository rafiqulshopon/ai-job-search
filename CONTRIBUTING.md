...
- **Document changes**: the CV is a Google Docs `.docx` (rendered to PDF via LibreOffice); the cover letter is LaTeX (`xelatex`, `cover.cls`). CI smoke-renders the CV and smoke-compiles the cover letter to catch breakage.
